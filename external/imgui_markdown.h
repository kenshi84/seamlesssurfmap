...
namespace ImGui
{
    ...
    inline void Markdown( const char* markdown_, size_t markdownLength_, const MarkdownConfig& mdConfig_ = MarkdownConfig());
    inline void Markdown(const std::string& markdown_, const MarkdownConfig& mdConfig_ = MarkdownConfig()) { Markdown(markdown_.c_str(), markdown_.length(), mdConfig_); }
